...
# FINGER DETECTION
                    ...
                    cv2.circle(painting_cursor,(right_hand[0],right_hand[1]),temp,[255,255,255],-1)
                    #cv2.imshow('right_hand_contours',drawing)
                    if(op[0][0]==0):
                        cv2.circle(painting,(right_hand[0],right_hand[1]),temp,[0,0,255],-1)
                    final_painting = painting + painting_cursor
                    #painting_cursor=0
                    cv2.imshow('painting',final_painting)
